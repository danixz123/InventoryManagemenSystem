 ...
 * @author Danica
 */
import com.mycompany.inventorysystemui.adminforms.WelcomeAdmin;
import com.mycompany.inventorysystemui.querymethods.DatabaseConnector;
import com.mycompany.inventorysystemui.userforms.InventoryMainSystemUser;
import java.sql.*;
...
//            ResultSet rs = checkStmt.executeQuery();
      ...
      } public static boolean addProduct(String product_name,String product_category,Integer product_quantity,Integer product_price,String total_price,Integer id,String date ) {
//          
         try (Connection conn = DatabaseConnector.getConnection()) {
            ...
            if (rs.next()) {
                ...
                String insertQuery = "INSERT INTO e_products (product_name, product_category,product_quantity,product_price,total_price,id,date) VALUES ( ?,?,?,?,?,?,?)";
                PreparedStatement insertStmt = conn.prepareStatement(insertQuery);
