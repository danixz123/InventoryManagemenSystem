...
public class LoadingFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Mel\\loadingIcon.jpg")); // NOI18N
        jLabel2.setOpaque(true);

        lblInventory.setBackground(new java.awt.Color(255, 255, 51));
        lblInventory.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lblInventory.setForeground(new java.awt.Color(255, 255, 255));
        lblInventory.setText("WELCOME TO E - INVENTORY");

        jLabel1.setBackground(new java.awt.Color(255, 255, 51));
        jLabel1.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("The best software for inventory management");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(100, 100, 100)
                        .addComponent(lblInventory, javax.swing.GroupLayout.PREFERRED_SIZE, 366, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblInventory, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel1)
                .addGap(54, 54, 54)
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(20, 19, 550, 381);
    ...
    public static void main(String args[]) {
      ...
      LoadingFrame wc = new LoadingFrame();
      wc.setVisible(true);
      
      LoginForm lgn = new LoginForm();
      wc.loadingBar.setValue(0);
      wc.loadingBar.setBackground(Color.blue);
      try{
   
         for (int i =0; i<100; i++) {
             Thread.sleep(50);
              wc.loadingBar.setBorderPainted(true);
